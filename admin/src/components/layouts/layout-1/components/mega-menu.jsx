...
export function MegaMenu() {
  ...
  // The entries below are read by index, so an empty MENU_MEGA would make
  // homeItem undefined and take the whole layout down on homeItem.path. This
  // panel has no mega menu — its items navigated the template's demo store and
  // profile pages — so render nothing rather than half a header.
  if (MENU_MEGA.length === 0) return null;
