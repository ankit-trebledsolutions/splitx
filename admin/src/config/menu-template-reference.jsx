...
export const MENU_SIDEBAR = [
  ...
  },
  {
    heading: 'Admin',
    anyPermissions: [
      PERMISSIONS.GENERAL_SETTINGS,
      PERMISSIONS.EMAIL_TEMPLATE,
      PERMISSIONS.CAROUSEL,
      PERMISSIONS.IMAGE_CAROUSEL,
  ...
  },
  {
    ...
    children: [
      {
        title: 'Users',
        path: '/layout-1/user-management',
      },
      {
        title: 'Co-Admins',
        path: '/layout-1/user-management/co-admins',
      },
    ],
  },
  {
    ...
    children: [
      {
        title: 'App',
        path: '/layout-1/general-settings',
        permission: PERMISSIONS.GENERAL_SETTINGS,
      },
      {
        title: 'Theme',
        path: '/layout-1/general-settings/theme',
        permission: PERMISSIONS.GENERAL_SETTINGS,
      },
      {
        title: 'Third-Party APIs',
        path: '/layout-1/general-settings/third-party-apis',
        permission: PERMISSIONS.GENERAL_SETTINGS,
      },
      {
        title: 'Email',
        path: '/layout-1/general-settings/email',
        permission: PERMISSIONS.GENERAL_SETTINGS,
      },
      {
        title: 'SEO',
        path: '/layout-1/general-settings/seo',
        permission: PERMISSIONS.GENERAL_SETTINGS,
      },
      {
        title: 'System',
        path: '/layout-1/general-settings/system',
        permission: PERMISSIONS.GENERAL_SETTINGS,
      },
    ],
  },
  {
    ...
    children: [
      { 
        ...
        path: '/layout-1/manage-cms',
        permission: PERMISSIONS.EMAIL_TEMPLATE,
      },
      {
        title: 'Carousel Management',
        path: '/layout-1/manage-cms/carousel-management',
        anyPermissions: [PERMISSIONS.CAROUSEL, PERMISSIONS.IMAGE_CAROUSEL],
      }
    ],
  },
  {
    ...
    icon: Kanban,
    permission: PERMISSIONS.MANAGE_CATEGORY,
    children: [
      { 
        title: 'Category', 
        path: '/layout-1/manage-category',
        permission: PERMISSIONS.MANAGE_CATEGORY,
      },
    ],
  },
